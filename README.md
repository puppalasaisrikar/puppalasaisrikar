...
**Machine Learning & AI**  
Regression, Random Forest, XGBoost, SVR, Neural Networks, Time Series Forecasting, Anomaly Detection (Isolation Forest), RAG Systems, LLMs, NLP, Prompt Engineering, Statistical Analysis, A/B Testing

**Programming & Data Engineering**  
Python (pandas, scikit-learn, LangChain, PySpark), SQL (T-SQL, PostgreSQL), R (Shiny, tidyverse), Git, ETL Pipeline Development, Data Quality Validation

**Cloud & Infrastructure**  
Azure (Data Lake, SQL Database, Data Factory, Blob Storage), Snowflake, PostgreSQL, MySQL, Docker, GitHub Actions, CI/CD, MLflow
